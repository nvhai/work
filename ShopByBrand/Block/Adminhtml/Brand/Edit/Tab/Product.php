 ...
 * @method array|null getBrandsProducts()
 * @method Product setBrandsProducts(array $products)
 */
class Product extends ExtendedGrid implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        if ($this->getBrands()->getId()) {
            $constraint = '{{table}}.brands_id='.$this->getBrands()->getId();
        } else {
            $constraint = '{{table}}.brands_id=0';
        }
    ...
    {
        $products = $this->getBrandsProducts();
        if (!is_array($products)) {
            $products = $this->getBrands()->getProductsPosition();
    ...
    {
        $selected = $this->getBrands()->getProductsPosition();
    ...
    public function getGridUrl()
    {
        return $this->getUrl(
            '*/*/productsGrid',
            [
                'brands_id' => $this->getBrands()->getId()
            ]
        );
    }
    ...
    {
        return $this->coreRegistry->registry('shopbybrand_brands');
    }
    ...
    {
        return $this->getUrl('shopbybrand/brands/products', ['_current' => true]);
    }
